...
class _FlareLoginPageState extends State<FlareLoginPage> {
  late FlareSignInController _signInController;
        ...
        Positioned.fill(
            child: Container(
              ...
              1.0
                        ...
                        colors: [
              Color.fromRGBO(96, 193, 201, 1),
              Color.fromRGBO(191, 235, 236, .7)
            ])))),
        Positioned.fill(
            ...
            child: Column(
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: FlareActor('assets/images/flare/Teddy.flr',
                          shouldClip: false,
...
class _TrackingTextInputState extends State<TrackingTextInput> {
  ...
  initState() {
    _textController.addListener(() {
      ...
      //  if (_debounceTimer.isActive!=null&&_debounceTimer.isActive==true) _debounceTimer.cancel();
