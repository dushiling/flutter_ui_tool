...
import '../delegates/custom_sliver_appbar_delegate.dart';
...
class _SliverWidgetState extends State<SliverWidget> {
  late AppBarBehavior _appBarBehavior;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          _buildSliverAppBar(),///1  AppBar
          _buildSliverToBoxAdapter(),///2  BoxAdapter
          _buildSliverPersistentHeader(),
          _buildSliverList(context),///3  List: BuilderDelegate
          _buildSliverPersistentHeader(),
          _buildSliverList2(context),///4  List: ListDelegate
          _buildSliverPersistentHeader(),
          _buildSliverGrid(context),///5  Grid
          _buildSliverPersistentHeader(),
          _buildSliverFixedExtentList(context),///6  ExtentList
          _buildSliverPersistentHeader(),
          _buildSliverFillViewport(),///7  Viewport: 每一个item都占满全屏
        ],
      ),
    );
  }
