...
class Data {
  ...
  static List<TabItem> items({required bool image}) {
    if (image) {
      return [
        TabItem<Image>(
          icon: Image.asset('assets/images/sample/sample-1.png'),
          activeIcon: Image.asset('assets/images/sample/sample-1-2.png'),
          title: 'Happy',
        ),
        TabItem<Image>(
            icon: Image.asset('assets/images/sample/sample-2.png'),
            activeIcon: Image.asset('assets/images/sample/sample-2-2.png'),
            title: 'New'),
        TabItem<Image>(
          icon: Image.asset('assets/images/sample/sample-3.png'),
          activeIcon: Image.asset('assets/images/sample/sample-3-2.png'),
          title: 'Year',
        ),
        TabItem<Image>(
          icon: Image.asset('assets/images/sample/sample-4.png'),
          activeIcon: Image.asset('assets/images/sample/sample-4-2.png'),
          title: '20',
        ),
        TabItem<Image>(
          icon: Image.asset('assets/images/sample/sample-5.png'),
          activeIcon: Image.asset('assets/images/sample/sample-5-2.png'),
          title: '21',
        ),
      ];
    }
