...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        ...
        labelName: 'Help',
        isAssetsImage: true,
        imageName: 'assets/images/sidebar1/supportIcon.png',
      ),
      DrawerList(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ColorsV.notWhite.withOpacity(0.5),
      body: Column(
        ...
        children: <Widget>[
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: <BoxShadow>[
                                BoxShadow(color: ColorsV.grey.withOpacity(0.6), offset: const Offset(2.0, 4.0), blurRadius: 8),
                              ],
                            ),
                            child: ClipRRect(
          ...
          Divider(
            height: 1,
            color: ColorsV.grey.withOpacity(0.6),
          ),
          Expanded(
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                      ? Container(
                          width: 24,
                          height: 24,
                          child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.blue : ColorsV.nearlyBlack),
                        )
                      : Icon(listData.icon?.icon, color: widget.screenIndex == listData.index ? Colors.blue : ColorsV.nearlyBlack),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.blue : ColorsV.nearlyBlack,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
