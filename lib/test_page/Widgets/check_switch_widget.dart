    ...
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
        ...
        Row(
          children: <Widget>[
            Switch(
                ...
                activeThumbImage: AssetImage('asssets/images/flutter_logo.png'),
                inactiveThumbImage: AssetImage('asssets/images/flutter_logo.png'),
        ...
        CheckboxListTile(
          ...
          secondary: Image.asset('assets/images/timg.gif', width: 30.0, height: 30.0),
        ...
        CheckboxListTile(
          ...
          // 和 checkbox 对立边的部件，例如 checkbox 在头部，则 secondary 在尾部
          secondary: Image.asset('assets/images/timg.gif', width: 90.0, height: 90.0),
          value: _isTitleChecked,
          onChanged: (checked) {
            setState(() => _isTitleChecked = checked!);
          },
        ...
        SwitchListTile(
            ...
            subtitle: Text(
                'description...description...\ndescription...description...'),
            secondary:
                Image.asset('assets/images/timg.gif', width: 30.0, height: 30.0),
            isThreeLine: true,
            value: _isTitleOn,
            selected: true,
            onChanged: (onState) {
