...
import 'child/models.dart';
import 'child/utils.dart';
...
class _CityListCustomHeaderPageState extends State<CityListCustomHeaderPage> {
  ...
  String imgFavorite = AddressUtils.getImgPath('ic_favorite');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SLAppBarWidget(title: '城市列表'),
      body: Column(
        children: [
          ListTile(
              title: Text("当前城市"),
          ...
          Expanded(
            child: AzListView(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return AddressUtils.getListItem(context, model,
              ...
              susItemBuilder: (BuildContext context, int index) {
                ...
                return AddressUtils.getSusItem(context, tag, susHeight: susItemHeight);
              },
