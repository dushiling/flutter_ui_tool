...
import 'child/condition.dart';
import 'child/dropdown_header.dart';
import 'child/dropdown_menu.dart';
import 'child/dropdown_menu_controller.dart';
import 'child/filter_listview.dart';
...
class _DropDownSampleState extends State<DropDownSample> {
  ...
  late Condition _selectBrandSortCondition;
  late Condition _selectDistanceSortCondition;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: SLAppBarWidget( title: '仿美团电影下拉筛选菜单'),
      backgroundColor: Colors.white,
      endDrawer: Container(
          margin: EdgeInsets.only(left: SizeUtil.width / 4, top: 0),
          color: Colors.white),
